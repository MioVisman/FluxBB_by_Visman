...
'Info 6'						=>	'Если требуется установить несколько форумов FluxBB в одну базу данных, измените это поле. <b>Для MySQL 8 префикс таблиц необходимо задать в обязательном порядке.</b>',

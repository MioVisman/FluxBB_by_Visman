...
'Censor words count label'			=>	'Цензура - ограничение',
'Censor words count help'			=>	'Если в сообщении/теме будет замененено больше слов, чем тут указано, то такое сообщение/тему не получится опубликовать/сохранить. Установите в 0 чтобы выключить.',

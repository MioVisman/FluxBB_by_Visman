...
if (file_exists(PUN_ROOT.'lang/'.$pun_user['language'].'/genders_integration.php'))
					...
					<fieldset>
						...
						<div class="infldset">
							...
							<table class="aligntop">
								...
								<tr>
									<th scope="row"><?php echo $lang_genders_integration['Gender'] ?></th>
									<td>
										<label class="conl"><input type="radio" name="form[gender]" value="1" /><?php echo $lang_genders_integration['Male'] ?></label>
										<label class="conl"><input type="radio" name="form[gender]" value="2" /><?php echo $lang_genders_integration['Female'] ?></label>
										<label class="conl"><input type="radio" name="form[gender]" value="0" /><?php echo $lang_genders_integration['Unknown'] ?></label>
									</td>
								</tr>
								<tr>
